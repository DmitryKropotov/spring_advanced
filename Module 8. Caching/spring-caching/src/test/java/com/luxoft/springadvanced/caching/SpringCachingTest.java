...
public class SpringCachingTest {
    ...
    @Test
    public void testPhoneNumberCachePutCondition() {
        Client john = new Client("John", "Bucharest, Calea Floreasca 167", "+38144");
        long time1 = System.nanoTime();
        service.getNumberCachePutCondition(john);
        john.setPhoneNumber("New phone number");
        long time2 = System.nanoTime();
        assertEquals("+38144", service.getCacheableAddress(john),
                () -> "The phone number should be updated");
        long time3 = System.nanoTime();
        long timeDiff1 = (time2-time1)/1000_000;
        long timeDiff2 = (time3-time2)/1000_000;
        System.out.println("Duration of the first execution  (phone number retrieved from client): " + timeDiff1);
        System.out.println("Duration of the second execution (phone number retrieved from cache): " + timeDiff2);

        Client mike = new Client("Mike", "Bucharest, Calea Floreasca 167", "+38177");
        time1 = System.nanoTime();
        service.getAddressCachePutCondition(mike);
        mike.setPhoneNumber("New phone number");
        time2 = System.nanoTime();
        assertEquals("New phone number", service.getCacheableAddress(mike),
                () -> "The phone number should be updated");
        time3 = System.nanoTime();
